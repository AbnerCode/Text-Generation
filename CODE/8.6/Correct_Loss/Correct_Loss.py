...
'''
loss:
epoch 1, loss 7.008375,
epoch 2, loss 13.116563,
epoch 3, loss 5.874396,
epoch 4, loss 5.811018,
epoch 5, loss 5.817262,
epoch 6, loss 5.741437,
epoch 7, loss 5.717822,
epoch 8, loss 5.645786,
epoch 9, loss 5.719849,
epoch 10, loss 5.611157,
'''
import collections
import io
import csv
...
for i in range(len(output_seqs)):
    fr[i] = nd.array(input_vocab.to_indices(input_seqs[i]), ctx=ctx)      #fr每一行将其转换成相应的index

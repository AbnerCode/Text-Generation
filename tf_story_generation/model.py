...
class Seq2SeqModel(object):
    def __init__(self, sess, rnn_size, num_layers, embedding_size, word_to_id,word_to_id_t,
        ...
        self.word_to_id_t = word_to_id_t

        self.vocab_size = len(self.word_to_id)
        self.vocab_size_t = len(self.word_to_id_t)
    ...
    def build_placeholder(self):
        ...
        self.embedding_t = tf.get_variable('embedding_t', [self.vocab_size_t, self.embedding_size])
    ...
    def build_train_decoder(self):
        ...
        decoder_inputs_embedded = tf.nn.embedding_lookup(self.embedding_t, decoder_input)
